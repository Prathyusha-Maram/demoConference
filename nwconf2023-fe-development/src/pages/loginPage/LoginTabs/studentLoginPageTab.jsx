...
const StudentLoginPageTab = () => {
  ...
  const GetApi = () => {
    axios.get(`${API_ENDPOINT}/student/my/project`, myheader).then((response) => {
  ...
  function checkStatus() {
    navigate("/checkStudentStatus", { state: userDatas });
  }
...
export default StudentLoginPageTab;
