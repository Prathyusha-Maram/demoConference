...
const StudentSignUpPage = () => {
  ...
  function studentsignup() {
    ...
    if (firstName !== "" && lastName !== "" && signupEmail !== "" && confrimSignupEmail !== "" && signUpPassword !== "" && confirmSignUpPassword !== "") {
      axios
        .post(`${API_ENDPOINT}/student/signup`, {
          firstName: firstName,
          lastName: lastName,
          email: signupEmail,
  ...
  return (
    <div className="login-container">
      <div className="login-con" style={{ margin: "40px 0" }}>
        ...
        <form onSubmit={studentsignup}style={{ display:"flex", flexDirection:"column" }}>
          ...
          <p>
            Already have an account? <NavLink to="/student/login">Login Here</NavLink>
          </p>
        </div>
