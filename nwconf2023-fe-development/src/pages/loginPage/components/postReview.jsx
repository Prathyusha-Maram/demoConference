...
const PostReview = () => {
  ...
  return (
    <div>
      <div className="user-postt">
        ...
        {/* {wantToReview === "No" ? 
          (
            <div>
              <p>Do you want to review?</p>
              <input type="checkbox" id="yes" name="wantToReview" value="yes" onChange={setWantToReview("Yes")}/>
              <label for="yes">Yes</label>
              <input type="checkbox" id="no" name="wantToReview" value="no" />
              <label for="no">No</label>
            </div>
          ) : null
        }
      ...
      {/* {wantToReview !== "" ? null : wantToReview !== "Yes" ? null : ( */}
